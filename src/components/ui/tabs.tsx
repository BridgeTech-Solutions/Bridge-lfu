...
/**
 * Tabs Root Component
 * This component acts as a container for all other Tabs components.
 * It uses the TabsPrimitive.Root from Radix UI.
 */
const Tabs = TabsPrimitive.Root

/**
 * TabsList Component
 * This component is a container for the TabsTrigger buttons.
 * It's styled to be a flexible row with a subtle background and rounded corners.
 */
 ...
 * This component represents a clickable tab button.
 * Its appearance changes when it's active (`data-[state=active]`).
 */
 ...
 * This component wraps the content for each tab.
 * It's styled to be a padded container and provides focus management.
 */
